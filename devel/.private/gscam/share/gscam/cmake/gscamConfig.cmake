...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/robot/catkin_ws/src/gscam)
  set(gscam_DEVEL_PREFIX /home/robot/catkin_ws/devel/.private/gscam)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/robot/catkin_ws/install)
...
if(NOT "/home/robot/catkin_ws/src/gscam/include;/usr/include/gstreamer-1.0;/usr/include/glib-2.0;/usr/lib/aarch64-linux-gnu/glib-2.0/include " STREQUAL " ")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/robot/catkin_ws/src/gscam/include;/usr/include/gstreamer-1.0;/usr/include/glib-2.0;/usr/lib/aarch64-linux-gnu/glib-2.0/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_ws/src/gscam/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gscam_NUM_DUMMY_TARGETS)
      set(gscam_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gscam::wrapped-linker-option${gscam_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gscam_NUM_DUMMY_TARGETS "${gscam_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gscam::wrapped-linker-option${gscam_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gscam_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robot/catkin_ws/devel/.private/gscam/lib;/home/robot/catkin_ws/devel/lib;/opt/ros/melodic/lib)
