...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/robot/catkin_ws/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/robot/catkin_ws/devel/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/robot/catkin_ws/install)
...
if(NOT "/home/robot/catkin_ws/src/vision_opencv/cv_bridge/include;/usr/include/opencv4 " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/robot/catkin_ws/src/vision_opencv/cv_bridge/include;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_ws/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_bridge;/usr/lib/aarch64-linux-gnu/libopencv_core.so.4.10.0;/usr/lib/aarch64-linux-gnu/libopencv_imgproc.so.4.10.0;/usr/lib/aarch64-linux-gnu/libopencv_imgcodecs.so.4.10.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robot/catkin_ws/devel/.private/cv_bridge/lib;/home/robot/catkin_ws/devel/lib;/opt/ros/melodic/lib)
