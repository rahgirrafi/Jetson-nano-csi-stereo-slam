...
set(MSG_I_FLAGS "-Itheora_image_transport:/home/robot/catkin_ws/src/image_transport_plugins/theora_image_transport/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/robot/catkin_ws/src/image_transport_plugins/theora_image_transport/msg/Packet.msg" NAME_WE)
add_custom_target(_theora_image_transport_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "theora_image_transport" "/home/robot/catkin_ws/src/image_transport_plugins/theora_image_transport/msg/Packet.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(theora_image_transport
  "/home/robot/catkin_ws/src/image_transport_plugins/theora_image_transport/msg/Packet.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/theora_image_transport)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/theora_image_transport\")")
  # install generated code
  install(
